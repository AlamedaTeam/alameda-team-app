  ...
  return (
    <div className="w-full max-w-xl mx-auto px-4">
      <div className="rounded-3xl bg-black/45 backdrop-blur-md border border-white/15 shadow-[0_20px_60px_rgba(0,0,0,0.45)] p-6 sm:p-8">
        ...
        <p className="text-center text-white/85 mb-6">Salidas, tests, puertas abiertas y competis del club.</p>

        <div className="grid gap-3">
          <button className="w-full h-12 rounded-xl border border-white/80 text-white bg-transparent">Ver calendario</button>
          <button className="w-full h-12 rounded-xl border border-white/40 text-white/90 bg-transparent">Apuntarme a un evento</button>
